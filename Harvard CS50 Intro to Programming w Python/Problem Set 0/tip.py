...
# accepts a string formatted as '$##.##', removes the leading $ and returns a float
def dollars_to_float(d):
    # replace method on string to get rid of dollar signs
    # don't forget it'll be like: d = d.replace('','')


def percent_to_float(p):
    # i think the same as above but it's bedtime
